...
// print details all countries includes 
//   country name area languages   independend or not  currency symbol
var newarray = []

for (country of DetailsOfCountries) {
  let countryName = country.name
  let countryArea = country.area
  let countryLanguages = country.languages[0].name
  let countryIndependend = country.independent
  //   let currencySymbol=country.currencies[0].symbol
  if ("currencies" in country) {
    let currencySymbol = country.currencies[0].symbol
    newarray.push(`Name:${countryName},Area:${countryArea},Language:${countryLanguages}
        
        ,Independend:${countryIndependend},Currency Syboml:${currencySymbol}`);

  }

  //   console.log(`Name:${countryName},Area:${countryArea},Language:${countryLanguages},`);
