var countries=[
  ...
  var newarray=[]
  //country name capital  population currencies
  for(let country of countries){
    ...
    if("currencies" in country){
      ...
      // console.log(`countryname:${countryName},capital:${countryCapital},population:${countryPopulation},currency:${currencyName}`);
      // newarray.push(`countryname:${countryName},capital:${countryCapital},population:${countryPopulation},currency:${currencyName}`)
    }
    // console.log(newarray);
    let countryData={countryName,countryCapital,countryPopulation,currencyName}
  newarray.push(countryData)
  }
  console.log(newarray);
  ...
  //print country names only
// for(count_name of newarray){
//   console.log(count_name.countryName);
// }
//      Foreach
newarray.forEach(count_name=>console.log(count_name.countryName))
//        find india details
var indiaDet=newarray.find(name_of_country=>name_of_country.countryName=="India")
console.log(indiaDet);

//find details of Andorra

// var find_Andorra=newarray.find(Name=>Name.countryName=="Andorra")
// console.log(find_Andorra);


    //     find china currency
var find_china_cuurency=newarray.find(Name=>Name.countryName=="China").currencyName
console.log(find_china_cuurency);



  //print country names that country population above 2 crore
var twocrore=countries.filter(popu=>popu.population>20000000).forEach(name=>console.log(name))
console.log(twocrore);
